...
class AutoTraderBot {
  ...
  _sendHelp(channel) {
    const embed = new Discord.RichEmbed()
      ...
      .addField('--min-price', 'The minimum price of the vehicle (e.g. --min-price 1000)')
      .addField('--max-price', 'The maximum price of the vehicle (e.g. --max-price 4000)')
      .addField('--make', 'The make of the vehicle (i.e. Ford, Nissan) (e.g. --make Ford)')
      .addField('--model', 'The model of the vehicle (i.e. Focus, Corsa) (e.g. --model Focus)')
      .addField('--variant', 'The variant of the vehicle (i.e. ST, GTI) (e.g. --variant ST)')
      .addField('--condition', 'The condition of the vehicle (New or Used) (e.g. --condition New)')
      .addField('--min-year', 'The minimum year of the vehicle\'s manufacture (e.g. --min-year 2010)')
      .addField('--max-year', 'The maximum year of the vehicle\'s manufacture (e.g. --max-year 2017)')
      .addField('--min-mileage', 'The minimum mileage of the vehicle (e.g. --min-mileage 50000)')
      .addField('--max-mileage', 'The maximum mileage of the vehicle (e.g. --max-mileage 120000)')
      .addField('--min-cc', 'The minimum CC of the vehicle, specifically for bikes')
      .addField('--max-cc', 'The maximum CC of the vehicle, specifically for bikes')
      .addField('--body', 'The body of the vehicle (i.e. SUV, Coupe)(e.g. --body SUV )')
